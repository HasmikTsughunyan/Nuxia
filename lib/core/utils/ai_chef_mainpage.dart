...
//final Map<String, String> dbDatabyallergens = await NetworkApiController.fetchUserActiveSubstitutesPipeline(); // 🌟 ԱՎԵԼԱՑՎԱԾ Է. Ստանում ենք ալերգենների տվյալները

List<String> textAllergens = NetworkApiController.personalizedDictionary; // 🌟 ԱՎԵԼԱՑՎԱԾ Է. Ստանում ենք ալերգենների ցուցակը

if (dbData['group_id'] == true) {
setState(() {
...
userAllergensGroups: _activeAllergensForAi,
),
),
);
},
